...
export const projects = [
  {
    ...
    features: ["Year-over-year sales, profit, and quantity KPI analysis", "Category and sub-category performance analysis", "Revenue versus profitability comparison", "Product-level performance exploration", "Interactive filtering for deeper comparisons"],
    ...
    metrics: [{ value: "$164.42M", label: "2023 sales" }, { value: "+20.6%", label: "sales YoY" }, { value: "$27.89M", label: "2023 profit" }, { value: "+43.7%", label: "profit YoY" }, { value: "12K", label: "2023 quantity" }, { value: "+26.8%", label: "quantity YoY" }],
    businessQuestions: ["How did sales, profit, and quantity change year over year?", "Which sub-categories contribute most to sales and profit?", "Where is high revenue not translating into equally strong profitability?", "Which periods show stronger or weaker performance?", "Which parts of the product portfolio deserve further investigation?"],
...
export const nav = [
  { id: "home", label: "Home" }, { id: "about", label: "About" }, { id: "projects", label: "Projects" }, { id: "sql", label: "SQL" }, { id: "experience", label: "Experience" }, { id: "skills", label: "Skills" }, { id: "certifications", label: "Certifications" }, { id: "education", label: "Education" }, { id: "contact", label: "Contact" },
];
