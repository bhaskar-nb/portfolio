...
export const projects = [
  { id: "sales-performance-dashboard", title: "Sales Performance Dashboard", stack: ["Tableau"], summary: "Interactive sales analysis focused on revenue, profit, quantity, year-over-year performance, and product profitability. Evidence: 20.6% year-over-year sales growth and 43.7% profit growth identified.", features: ["Year-over-year sales, profit, and quantity KPIs", "Product and sub-category profitability analysis", "Interactive filters for exploring performance trends"], challenges: "How can sales performance be compared across time and products while keeping the dashboard useful for business decision-making?", approach: "Structured the dashboard around core performance KPIs, year-over-year comparison, and product profitability so users can move from overall performance to specific product patterns.", evidence: "The analysis identified 20.6% year-over-year sales growth and 43.7% profit growth.", learnings: "Strengthened KPI design, comparative analysis, dashboard hierarchy, and business storytelling.", github: "https://github.com/bhaskar-nb/sales-dashboard", demo: "https://public.tableau.com/app/profile/bhaskar.nakka4980/viz/SalesDashboardProject_17823218142750/SalesDashboard" },
