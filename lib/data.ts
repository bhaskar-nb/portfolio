...
export const projects = [
  ...
  { id: "amazon-prime-content-intelligence", title: "Amazon Prime Content Intelligence Dashboard", stack: ["Tableau"], summary: "Catalog analysis exploring movies versus TV shows, genres, ratings, release trends, countries, and content composition.", features: ["Movies versus TV shows comparison", "Genre, rating, country, and release-year analysis", "Interactive views for exploring catalog composition"], challenges: "How can a large streaming catalog be broken into useful patterns across content type, genre, ratings, geography, and release trends?", learnings: "Strengthened categorical analysis, trend analysis, geographic breakdowns, and dashboard storytelling.", github: "https://github.com/bhaskar-nb/amazon-prime-dashboard", demo: "https://public.tableau.com/app/profile/bhaskar.nakka4980" },
];

export const additionalProjects = [
  { id: "global-disaster-analysis", title: "Global Disaster Analysis", category: "Data Visualization", stack: ["Tableau"], summary: "Analysis of disaster events, deaths, affected populations, economic damage, disaster types, countries, and time trends.", github: "https://github.com/bhaskar-nb/disaster-dashboard", demo: "https://public.tableau.com/app/profile/bhaskar.nakka4980" },
