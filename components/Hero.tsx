    ...
    <section id="home" className="relative flex min-h-[100svh] items-center overflow-hidden pt-28 pb-16">
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-12 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          ...
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.95 }} className="mt-7 flex flex-wrap gap-5 border-t border-base-500/60 pt-4 font-mono text-xs text-ink-300">
            <span><strong className="text-ink-100">4+</strong> analytics projects</span>
            <span><strong className="text-ink-100">150K+</strong> records analyzed</span>
            <span><strong className="text-ink-100">20.6%</strong> sales growth identified</span>
          </motion.div>
        </div>
