...
export default function About() {
  return (
    <section id="about" className="relative mt-16 overflow-hidden py-8 sm:mt-20 sm:py-10">
      ...
      <div className="relative mx-auto flex h-[500px] w-full max-w-[1100px] items-center overflow-hidden rounded-[2rem] border-[5px] border-violet-500/40 bg-gradient-to-br from-[#0a0a0a] via-[#111111] to-[#1a1a1a] px-5 py-4 shadow-[0_0_30px_rgba(168,85,247,0.22)] sm:px-6 lg:px-7">
        <motion.div
          initial={{ opacity: 0, y: 24 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.2 }}
          transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
          className="relative flex w-full flex-col items-center justify-between gap-6 px-2 sm:px-4 lg:flex-row lg:items-center lg:px-5"
        >
          <div className="basis-full lg:basis-7/12 lg:border-r lg:border-violet-500/30 lg:pr-8">
            <div className="text-left">
              <h2 className="font-display text-3xl font-bold text-white sm:text-4xl">
                About Me
              </h2>

              <div className="mt-4 text-sm leading-6 text-ink-300 sm:text-base">
                <BlurText
              ...
              <div className="mt-3 space-y-2 text-xs leading-5 text-ink-400 sm:text-sm sm:leading-6">
                <BlurText
              ...
              <div className="mt-6 grid grid-cols-3 gap-4 text-center sm:text-left">
                {metrics.map((metric, index) => (
                  ...
                  >
                    <h3 className="font-display text-2xl font-semibold leading-none text-white sm:text-3xl">
                      {metric.value}
                    </h3>
                    <p className="mt-1 text-[9px] uppercase tracking-[0.1em] text-ink-500 sm:text-[10px]">
                      {metric.label}
                    </p>
                  </motion.div>
                ))}
              ...
              <div className="mt-5">
                <ShinyText
                  ...
                  speed={3}
                  className="text-xs text-violet-300 sm:text-sm"
                />
              </div>
            </div>
          </div>
          ...
          <div className="basis-full lg:basis-5/12">
            ...
            >
              <div className="relative mt-14 w-[250px]">
                <div className="absolute left-1/2 top-[-90px] h-[94px] w-[3px] -translate-x-1/2 bg-gradient-to-b from-black via-black to-[#171717]" />
