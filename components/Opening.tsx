    ...
    <section id="opening" className="relative flex h-[100dvh] min-h-[560px] w-full items-end justify-center overflow-hidden bg-base-900">
      <div className="relative h-full w-full max-w-[1920px]">
        <motion.div
          ...
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 top-[38%] z-0 w-max -translate-x-1/2 -translate-y-1/2 select-none whitespace-nowrap text-center text-[clamp(4.2rem,14vw,17rem)] font-black uppercase leading-[0.78] tracking-[-0.095em]"
          style={{
