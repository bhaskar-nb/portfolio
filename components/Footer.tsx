    ...
    <footer className="relative overflow-hidden border-t border-base-500/70 pt-14 pb-8">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 border-b border-base-500/70 pb-10 md:grid-cols-[1fr_auto] md:items-end">
          ...
          <a href="#contact" className="group inline-flex items-center gap-2 rounded-full border border-gold/40 bg-gold/10 px-5 py-3 font-mono text-[10px] uppercase tracking-[0.16em] text-gold transition-all hover:border-gold hover:bg-gold/15">
        ...
        <div className="flex flex-col gap-6 pt-7 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 font-mono text-[9px] uppercase tracking-[0.14em] text-ink-600">Data · Analytics · Visualization</p>
          </div>
